...
/* ✅ Updated to match real ML model classes */
const recommendations: Record<string, string> = {
  CNV: "Choroidal Neovascularization detected. Immediate consultation with a retinal specialist is recommended. Anti-VEGF therapy may be required.",
  DME: "Diabetic Macular Edema suspected. Blood sugar monitoring and ophthalmologist consultation are strongly advised.",
  DRUSEN:
...
function ResultContent() {
  ...
  if (condition === "NORMAL") severity = "Normal";
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <div>
            ...
            <p className={`text-xl font-bold mt-0.5 ${sev.color}`}>
              {severity}
            </p>
          </div>
        </div>
      ...
      <div className="rounded-xl bg-gray-800 border border-gray-700 p-5 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <p className="text-gray-300 font-semibold text-sm">Recommendation</p>
        </div>
